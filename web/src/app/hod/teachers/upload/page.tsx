...
export default function TeachersUploadPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 text-left">Bulk Upload Teachers</h1>
        <p className="text-slate-500 mt-1 text-left">Import teachers from CSV file</p>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-100">
        ...
        <div className="bg-slate-50 rounded-xl p-4 font-mono text-sm text-slate-700">
          <p className="text-left">name,email,phone,department_code</p>
          <p className="text-left text-slate-400">John Smith,john@mit.edu,9876543210,CSE</p>
          <p className="text-left text-slate-400">Jane Doe,jane@mit.edu,9876543211,AIML</p>
        </div>
